	...
	<div class="container">
		...
		<form class="form-signin"
			...
			<label for="inputEmail" class="sr-only">Email address</label> <input
				id="inputEmail" name="clis_email" class="form-control"
				placeholder="Email address" required="" autofocus="" type="email">
			<label for="inputPassword" class="sr-only">Password</label> <input
				id="inputPassword" name="clis_pass" class="form-control"
				placeholder="Password" required="" type="password"> <input
				type="hidden" name="<%out.print(Switch.REQUIRED_CLASSNAME_LBL); %>"
				value="controller.UserService" /> <input type="hidden"
