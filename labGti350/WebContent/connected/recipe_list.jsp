...
<body>
	...
	<div class="container">
		...
		<%
			List<Recipe> list2 = (List<Recipe>) request
					.getAttribute(UserManageRecipeService.RECIPE_LIST);

			if (list2 != null) {
		%>

		<!-- -------------------------------Recipe LIST FROM A SELECTION ------------------ -->
				...
				<div class="list-group">
					<%
						for (int i = 0; i < list2.size(); i++) {
								...
								Recipe r = (Recipe) list2.get(i);
					%>
					<div class="list-group-item ">
						</br>
						<h4 class="list-group-item-heading"><%=r.getName()%></h4>
						<a
							href="${pageContext.request.contextPath}<%="/gate?"+Switch.REQUIRED_CLASSNAME_LBL+"=controller.UserManageRecipeService&"+Service.REQUESTED_SERVICE_LBL+"=displayRecipeDetails&"
						+UserManageRecipeService.RECIPE_ID+"="+r.getId()%>"
